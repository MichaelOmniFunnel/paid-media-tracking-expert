...
- Read `agents/tracking-auditor.md` for methodology
...
- Read `agents/landing-page-analyst.md` for methodology
...
- Read `agents/signal-architect.md` for methodology
